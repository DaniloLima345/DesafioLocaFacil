...
public class ClienteController {
	...
	@Transactional
	@PutMapping("/{id}")
	public ResponseEntity<Cliente> alterar(@RequestBody Cliente clienteAtualizado, @PathVariable Long id) throws SQLException{
	...
	@Transactional
	@DeleteMapping("/{id}")
	public ResponseEntity<Cliente> deletar(@PathVariable Long id) throws SQLException {
